  ...
  return (
    <PageShell>
      <section className="mx-auto flex max-w-7xl justify-center px-4 pb-16 pt-8 sm:px-6 lg:px-8">
        <Card className="w-full max-w-xl border border-emerald-400/20 bg-[linear-gradient(180deg,rgba(16,185,129,0.12),rgba(15,23,42,0.6))]">
          <CardHeader>
            <Badge className="w-fit border border-emerald-400/20 bg-emerald-500/10 text-emerald-200">Sign Up</Badge>
            <CardTitle className="pt-4 text-3xl text-white">Create your OFI Pro account</CardTitle>
            <CardDescription className="text-slate-200/80">
              Join with email/password or Google, then upgrade into Pro or Institutional access whenever you are ready.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950/60 p-5">
              <div className="flex items-center gap-3 text-white">
                ...
                <span className="font-medium">Free starts, premium upgrades later</span>
              </div>
              <div className="mt-2 text-sm leading-6 text-slate-300">
                Create your account now, analyze for free, and upgrade inside pricing when you want the full OFI Pro workflow.
              </div>
            </div>
